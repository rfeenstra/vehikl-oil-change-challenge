...
@section('content')
    <div class="flex flex-col gap-4 rounded-lg border border-gray-200 bg-zinc-100 px-10 py-8">
        <h1 class="text-4xl font-bold">Vehicle Oil Change Check</h1>
        <form action="{{ route('check.store') }}" method="POST" class="mt-2">
            ...
            <div class="flex flex-col gap-4">
                <div class="form-group">
                    ...
                    <input type="number" name="current_odometer" id="current_odometer" value="{{ old('current_odometer') }}" class="rounded border border-zinc-300 bg-white px-2 py-1">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="previous_date" id="previous_date" value="{{ old('previous_date') }}" class="rounded border border-zinc-300 bg-white px-2 py-1">
                    @error('previous_date')
                        <div class="text-red-500">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="number" name="previous_odometer" id="previous_odometer" value="{{ old('previous_odometer') }}" class="rounded border border-zinc-300 bg-white px-2 py-1">
